  ...
  implements ClientCommandHandler, ClientEventHandler
{
    ...
    throws SocketTimeoutException, IOException
  {
     ...
     * 
     * 
     * TeamTrac Mobile Tracker
     * $PGID,864587020064664*02
	 * 	$TRCCR,20150403050558.346,A,12.999805,80.263899,0.00,0.00,0.00,100,*05
	 * 	$TRCCR,20150403050558.346,A,12.999805,80.263899,0.00,0.00,0.00,100,*05
	 * 	$TRCCR,20150403050620.098,A,12.999805,80.263900,0.00,0.00,0.00,100,*08
	 * 	$TRCCR,20150403050640.008,A,12.999820,80.263900,0.00,0.00,0.00,100,*00
	 * 
	 ...
	 * 
	 * 
	 * 	$GPRMC,050658.501,A,1259.9887,N,08015.8335,E,0.00,0.00,030415,,*0a
	 * 	$GPRMC,050658.501,A,1259.9887,N,08015.8335,E,0.00,0.00,030415,,*0a
     * 
...
//      Double speed = Double.valueOf(0.0D);
      ...
      PacketType = deviceInfoArr[0].replace("$", "");       //$PGID, $TRCCR, $GPRMC
//      $TRCCR,20150403050558.346,A,12.999805,80.263899,0.00,0.00,0.00,100,*05
      if(PacketType == "TRCCR"){
